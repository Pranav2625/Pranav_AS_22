...
class Main_screen:
  def __init__(self, parent):
    ...
    def two_play():
      print("two players")
      # get_dble_username = Double_Username(self)
      # get_dble_username.dble_usrnme_text.configure(text = "Enter in usernames for the two players")

    def three_play():
      print("Three players")

  def single_username(self):                                           # When the single player button is pressed
    get_sngle_usernme = Single_Username(self)                          # Calls on the Single_Username class
    get_sngle_usernme.sngle_usernme_text.configure(text = "Enter in a username") # and makes the heading of the window
